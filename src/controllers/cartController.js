...
exports.addToCart = async (req, res) => {
  try {
    ...
    const existingItemIndex = cart.articles.findIndex((item) => item.product.toString() === productId)
...
exports.updateCartItem = async (req, res) => {
  try {
    ...
    const itemIndex = cart.articles.findIndex((item) => item.product.toString() === productId)
...
exports.removeFromCart = async (req, res) => {
  try {
    ...
    cart.articles = cart.articles.filter((item) => item.product.toString() !== productId)
